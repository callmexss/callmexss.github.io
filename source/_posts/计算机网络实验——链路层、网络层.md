...
{% asset_img 5-arp_packet_format.jpg 图5 ARP报文结构 %}
...
|   类别   | 主机名 |    接口地址   |
|:--------:|:------:|:-------------:|
|  源主机  |   sun  | 140.242.13.33 |
| 目的主机 |  gemini  | 140.252.1.11 |
...
经过与主机sun通信以后，发现在同一个子网140.252.1上的netb和sun的IP地址映射的硬件地址是相同的。这通常是使用委托ARP的线索。
